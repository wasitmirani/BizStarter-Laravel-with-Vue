...
const { warehouse, errors, isLoading, onSubmit } = useWarehouseForm(props?.warehouseData, props?.isEditMode);
</script>
        ...
        <form @submit.prevent="onSubmit">
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormInput v-model="warehouse.phone" label="Phone Number" name="phone" type="text" :errors="errors" />
                    <FormInput v-model="warehouse.address" label="Address" name="address" type="text" :errors="errors" class="md:col-span-2" />
                    <FormInput v-model="warehouse.country" label="Country" name="country" type="text" :errors="errors" />
                    ...
                    <div class="md:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-3">
                        <label class="inline-flex items-center gap-2"><input type="checkbox" v-model="warehouse.is_default" /> Default</label>
                        <label class="inline-flex items-center gap-2"><input type="checkbox" v-model="warehouse.allow_partial_packing" /> Partial packing</label>
                        <label class="inline-flex items-center gap-2"><input type="checkbox" v-model="warehouse.allow_partial_picking" /> Partial picking</label>
                        <label class="inline-flex items-center gap-2"><input type="checkbox" v-model="warehouse.scan_unique_location" /> Scan location</label>
                        <label class="inline-flex items-center gap-2"><input type="checkbox" v-model="warehouse.scan_unique_container" /> Scan container</label>
                    </div>
                </div>
            </div>
