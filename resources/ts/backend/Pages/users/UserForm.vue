...
const { user, errors, isLoading, showPassword, genderDropdownItems, maritalStatusDropdownItems, onSubmit, onInput, addThumbnail, togglePassword, generatePassword, copyPassword } = useUserForm();
        ...
        <div class="w-full flex flex-col card pointer-events-auto">
            ...
            <div class="card-body">
                <div class="grid lg:grid-cols-3 grid-cols-2 gap-base">
                    ...
                    <FormInput v-model="user.zip_code" label="Postal/Zip code" name="zip_code"
                                                ...
                                                <FormInput v-model="user.dob" label="Date Of Birth" name="dob"
                                                placeholder="Date Of Birth" type="date" :errors="errors" autofocus />
            ...
            <div class="flex justify-end items-center gap-2 p-5 border-t border-default-300">
                ...
                <router-link :to="{ name: 'users' }" class="btn bg-light hover:text-primary">
                        ...
                        <button class="btn bg-primary hover:bg-success-hover text-white" type="button" disabled v-if="isLoading">
